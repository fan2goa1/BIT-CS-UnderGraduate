...
int main(){
    ...
    cout << pos << endl;
    CMyString str_num;
    str_num = 123;                               // str_num is "123"
    int a = str_num.ToInt();                    // a = 123
    cout << a << endl;
    str_num = 123.456;                          // str_num is "123.456"
    double b = str_num.ToDouble();              // b is 123.456
    cout << b << endl;
    int start = 0, len = 2;
    CMyString my = s2.Mid(start, len);          // start represents starting position, len represents the length of substring. So Mid can get a substring "ov".
    cout << my << endl;
    return 0;
}